                    ...
                    <Grid container spacing={{ xs: 2, md: 2 }} style={{ display: 'flex' }}>
                        <Grid item xs={12} sm={12} md={12} >
                            ...
                            <Box sx={{ mt: 4, display: 'flex', justifyContent: 'center' }}>
                                <Paper elevation={5} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: { xs: '100%', lg: '43ch' }, width: '80%', p: 1,overflow: 'auto' }}>
                                    {section === 0 ? <PersonalInfo userDetails={userDetails} handleUserDetails={handleUserDetails} /> :
                                        section === 1 ? <ContactInfo contactInfo={contactInfo} setContactInfo={setContactInfo} /> :
                                            section === 2 ? <FamilyInfo familyData={familyData} setFamilyData={setFamilyData} /> :
                                                section === 3 ? <FunInfo funInfo={funInfo} setFunInfo={setFunInfo} /> :
                                                    section === 4 ? <TimeZone timezoneInfo={timezone} setTimeZoneInfo={setTimezone} /> :
                                                        section === 5 ? <ViewExperience experience={experienceData} setExperience={setExperienceData} /> : <></>}
                                </Paper>
